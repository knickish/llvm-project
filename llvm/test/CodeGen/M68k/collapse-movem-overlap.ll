; RUN: llc -mtriple=m68k-linux -verify-machineinstrs %s -o -
; This used to trigger an assertion in the M68kCollapseMOVEM pass due to
; overlapping register masks when attempting to collapse MOVEM chains.
