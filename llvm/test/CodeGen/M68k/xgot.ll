...
; ; CHECK-NEXT:    lea _GLOBAL_OFFSET_TABLE_, %a0 ; encoding: [0x41,0xf9,A,A,A,A]
; ; CHECK-NEXT:    ; fixup A - offset: 2, value: _GLOBAL_OFFSET_TABLE_, kind: FK_Data_4
; ; CHECK-NEXT:    lea (0,%pc,%a0), %a0 ; encoding: [0x41,0xfb,0x88,0x00]
...
declare void @FuncPtr(...)

define void @ReadFuncPtr() {
; CHECK-LABEL: ReadFuncPtr:
; CHECK:         .cfi_startproc
; CHECK-NEXT:  ; %bb.0: ; %entry
; CHECK-NEXT:    suba.l #4, %sp ; encoding: [0x9f,0xfc,0x00,0x00,0x00,0x04]
; CHECK-NEXT:    .cfi_def_cfa_offset -8
; CHECK-NEXT:    move.l (0,%pc), %a0 ; encoding: [0x20,0x7a,0x00,0x00]
; CHECK-NEXT:    jsr (%a0) ; encoding: [0x4e,0x90]
entry:
  call void @FuncPtr()
  unreachable
}
